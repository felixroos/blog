...
/** alternative hierarchy that returns raw JSON */
/* export function hierarchyJSON(node, getChildren = d => d.children) {
...
export function hierarchyJSON(root, getChildren = n => n.children) {
...
// to be used with current hierarchyJSON, run in rhythmEvents for root and node

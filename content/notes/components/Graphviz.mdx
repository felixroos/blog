...
Currently pretty hacky, as the script is loaded from jsdeliver.. did not find a way to bundle the module.
But this lib is the only one i found that could handle large graphs without looking like shit.

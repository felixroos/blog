...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/SBDTZcyyu3w"
  frameborder="0"
...
It reminds me of [SPC-700 VST](http://picopicose.com/software.html), but it seems much more stable and thought out.
...
```sh
for f in *.spc; do "path/to/spc/files" "$f" "$f.mid" --loop 1;done
```

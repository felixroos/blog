...
Note that we are now using chroma differences without dividing by 2.

## All The Things You Are

Now that we can generate graphs of any complexity, let's step up our game and visualize a more complex tune.

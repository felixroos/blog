...
In this case, we have a match before we even had to check "D phrygian" and "D aeolian" in the second 251.
This works because:
...
In this case, we can ignore the first "C lydian" as well as the second time "D phrygian" and "D aeolian", because they are not as promising.
This saves calculation time, which might seem small in this case, but it will be a life saver for bigger graphs.

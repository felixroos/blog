...
<PathTree
  ...
  getValue={(a, b) => scaleDifference(a, b)}
...
<PathTree
  ...
  getValue={(a, b) => scaleDifference(a, b) / 2}
  getColor={(scale) => scaleColor(scale)}
/>
...
<!--<PathGraph height={300} paths={step1} />-->

<PathTree height={300} paths={step1} getColor={(scale) => scaleColor(scale)} />
...
<!--<PathGraph height={300} paths={step2} getValue={getValue} />-->

<PathTree height={300} paths={step2} getColor={(scale) => scaleColor(scale)} />
...
<!--<PathGraph height={300} paths={step3} getValue={getValue} />-->

<PathTree height={300} paths={step3} getColor={(scale) => scaleColor(scale)} />
...
<!--<PathGraph height={300} paths={step4} getValue={getValue} />-->
<PathTree height={300} paths={step4} getColor={(scale) => scaleColor(scale)} />

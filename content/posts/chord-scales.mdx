...
<PathBuilder
  ...
  view={'graph'}
  scales={['major', 'dorian', 'lydian', 'mixolydian', 'aeolian', 'phrygian dominant', 'locrian 6', 'harmonic minor']}
  chords={['CmM7', 'Gm7', 'C7', 'F^7', 'Fm7', 'Bb7', 'Eb^7', 'Ebm7', 'Ab7', 'Db^7', 'Dm7b5', 'G7b9']}
/>
    ...
    json={{
      graph: {
        ...
        ...chordScaleGraph(
          ...
          ['major', 'dorian', 'lydian', 'mixolydian', 'aeolian', 'phrygian dominant', 'locrian 6','harmonic minor']
        ),
      },
    }}
  />

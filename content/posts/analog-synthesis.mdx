...
import raveFilterVCAMelody from './audio/vco-rave-filter-vca-melody.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFilterVCAMelody} controls />
...
import raveFilterVCAADSRMelody from './audio/vco-rave-filter-vca-adsr-melody.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFilterVCAADSRMelody} controls />

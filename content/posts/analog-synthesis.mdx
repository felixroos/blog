...
Lately, I've been learning about analog synthesis. In this post, I want to document what I've learned so far and how I approached the topic.
Note that I am still learning and I am no expert.
...
Conceptually this looks something like this: (You don't need to understand anything at this point)
...
The higher complexity of digital synthesis allows much more fine grained control, whereas analog synthesis can sometimes behave in unexpected ways.
...
import rave from './audio/vco-rave.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={rave} controls />
...
import raveFiltered from './audio/vco-rave-filter.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFiltered} controls />
...
- The triangle output is connected with the filter frequency input
...
import raveFilterLFO from './audio/vco-rave-filter-lfo.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFilterLFO} controls />
...
import raveFilterLFOAttenuator from './audio/vco-rave-filter-lfo-attenuator.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFilterLFOAttenuator} controls />
...
Using the pitch modulation attenuator, we can create a spacey melody ontop:

import raveFilterLFOAttenuatorMelody from './audio/vco-rave-filter-lfo-attenuator-melody.mp3';

<ReactAudioPlayer type="audio/x-m4a" src={raveFilterLFOAttenuatorMelody} controls />
...
Using the gate to control our amplifier sounds really hard. 
...
![ADSR sketch](./img/analog-synthesis/bb_simplest_synthesizer.png)

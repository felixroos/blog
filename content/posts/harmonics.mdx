...
Triangle waves can be produced by plucking a string exactly at the center. It contains only odd partials, with an amplitude of
...
As square waves cannot be produced in an analog way, they have a digital and unnatural hard feel.

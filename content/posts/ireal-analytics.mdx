...
import {
  ...
  RealChords,
  RealDiversity
} from '../components/ireal/RealParser.tsx';
...
<Grid spacing={0} container style={{ width: 800 }}>
  <Grid item xs={6}>
    <strong>
      <a href="https://www.irealb.com/forums/showthread.php?8483-Pop-400">
        Pop 400
      </a>
    </strong>
    <br />
  ...
  <Grid item xs={6}>
    <strong>
      <a href="https://www.irealb.com/forums/showthread.php?12753-Jazz-1350-Standards">
        Jazz 1350
      </a>
    </strong>
    <br />

...
import PianoRoll, {
  rhythmicalRoll
} from '../components/rhythmical/PianoRoll.tsx';
import { flatRhythm } from '../components/rhythmical/rhythmical.ts';
import RhythmicalTree from '../components/rhythmical/RhythmicalTree.tsx';
...
[
  ...
  { value: 'E4', time: 1, duration: 5 },
  { value: 'G4', time: 1.5, duration: 5 },
...
<PianoRoll
  noteRange={['C4', 'D5']}
  events={rhythmicalRoll(['C4', ['E4', 'G4'], 'B4', 'D5'])}
/>
...
[
  { value: 'C4', path: [[0, 4]] },
  { value: 'E4', path: [[1, 4], [0, 2]] },
  { value: 'G4', path: [[1, 4], [1, 2]] },
  { value: 'B4', path: [[2, 4]] },
  { value: 'D5', path: [[3, 4]] }
];
```
...
```ts
export function flatRhythm<T>(array: NestedArray<T>, whole = 1) {

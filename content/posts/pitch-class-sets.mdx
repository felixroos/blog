...
<p>
  reflect {scaleChroma('C major')} > {scaleChroma('Ab major')}
</p>
...
<ChromaticCircle {...relectedCircle(scaleReflection('C major', 7, false, 'Bb'), 'G 4A')} />
<br />
...
<ChromaticCircle {...scaleCircle('C major')} />
<ChromaticCircle {...scaleCircle(scaleReflection('C major', 4, true))} />

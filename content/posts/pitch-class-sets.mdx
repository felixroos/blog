...
<State initial={{ scale: 'C major' }}>
  {({ state, setState }) => {
    ...
    const scales = scaleModes('major','harmonic minor','melodic minor').sort(byCenter);
        ...
        <center>
          <Grid spacing={0} container style={{ width: '100%' }} alignItems="center">
            <Grid item xs={6}>
              ...
              <Button color="primary" onClick={() => setScale(rotateScale(-4, state.scale, scales))}>
                rotate scale
              </Button>
              <Button color="primary" onClick={() => setScale(rotateTonic(4, state.scale, scales))}>
                rotate tonic
              </Button>
            ...
            <Grid item xs={6}>
              ...
              <Button color="primary" onClick={() => setScale(rotateScale(1, state.scale, scales))}>
                rotate scale
              </Button>
              <Button color="primary" onClick={() => setScale(transposeScale(-1, state.scale))}>
                transpose
              </Button>
              <Button color="primary" onClick={() => setScale(rotateTonic(1, state.scale, scales))}>
                rotate tonic
              </Button>
            </Grid>
          </Grid>

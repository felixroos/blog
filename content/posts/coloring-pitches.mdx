...
<ColorKeyboard options={{ scaleX: 1, scaleY: 1, range: ['C2', 'C6'] }} colorizer={(note) => sinebow(note).toHexString()} />

### Less angry rainbow

<ColorKeyboard options={{ scaleX: 1, scaleY: 1, range: ['C2', 'C6'] }} colorizer={(note) => rainbow(note).toHexString()} />

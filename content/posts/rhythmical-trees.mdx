...
Using those, we can determine the absolute values of time and duration for each event.
        ...
        onNode={(node) => {
          ...
          const calculation = (
            <React.Fragment>
              ...
              <p>If 2 bars of bolero take 6s, the absolute time and duration are:</p>
